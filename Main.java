...
public class Main {
    ...
    public static void attachContextMenu(JComponent component) {
        ...
        component.addMouseListener(new MouseAdapter() {
            ...
            private void showPopupIfTriggered(MouseEvent e) {
                // Wichtig: isPopupTrigger() statt e.getButton() == 3,
                // damit es auf Windows, Mac und Linux korrekt funktioniert
                if (e.isPopupTrigger()) {
    ...
    public static JPopupMenu createContextMenu() {
        ...
        editItem.addActionListener(e -> System.out.println("Bearbeiten geklickt"));
